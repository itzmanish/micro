...
import (
	...
	ahandler "github.com/itzmanish/go-micro/v2/api/handler"
	aapi "github.com/itzmanish/go-micro/v2/api/handler/api"
	"github.com/itzmanish/go-micro/v2/api/handler/event"
	ahttp "github.com/itzmanish/go-micro/v2/api/handler/http"
	arpc "github.com/itzmanish/go-micro/v2/api/handler/rpc"
	"github.com/itzmanish/go-micro/v2/api/handler/web"
	"github.com/itzmanish/go-micro/v2/api/resolver"
	"github.com/itzmanish/go-micro/v2/api/resolver/grpc"
	"github.com/itzmanish/go-micro/v2/api/resolver/host"
	"github.com/itzmanish/go-micro/v2/api/resolver/path"
	...
	"github.com/itzmanish/go-micro/v2/api/server/acme/autocert"
	"github.com/itzmanish/go-micro/v2/api/server/acme/certmagic"
	httpapi "github.com/itzmanish/go-micro/v2/api/server/http"
	log "github.com/itzmanish/go-micro/v2/logger"
	"github.com/itzmanish/go-micro/v2/sync/memory"
	"github.com/itzmanish/micro/v2/client/api/auth"
	"github.com/itzmanish/micro/v2/internal/handler"
	"github.com/itzmanish/micro/v2/internal/helper"
	"github.com/itzmanish/micro/v2/internal/namespace"
	rrmicro "github.com/itzmanish/micro/v2/internal/resolver/api"
	"github.com/itzmanish/micro/v2/internal/stats"
